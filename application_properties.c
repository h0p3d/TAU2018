...
/// Used by the OTA to check that application version matches the stack version
#define APP_PROPERTIES_CAPABILITIES 0
...
KEEP_SYMBOL const ApplicationProperties_t applicationProperties = {
  ...
  .app = {
    ...
    .capabilities = APP_PROPERTIES_CAPABILITIES,
