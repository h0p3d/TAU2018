...
static uint16_t generatedLenList[] = { 128, 16,  };
static RAIL_FrameType_t generated_frameTypeConfig = {
  (uint16_t *)&generatedLenList[0], 0, 1, 0x3, 0x3
};
static const uint8_t generated_irCalConfig[] = {
  24, 68, 6, 6, 4, 16, 0, 1, 1, 2, 1, 6, 0, 16, 39, 0, 0, 9, 0, 0, 0, 0, 0, 0, 0
};

static const uint32_t generated_phyInfo[] = {
  3UL,
  0x02000000UL, // 512.0
  (uint32_t) &generated_frameTypeConfig,
